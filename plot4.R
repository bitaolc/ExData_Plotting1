...
plot(hpc$Day, as.numeric(hpc$Voltage), type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(hpc$Day, as.numeric(hpc$Global_reactive_power), type = "l", xlab = "", ylab = "Global_reactive_power")
dev.off()
